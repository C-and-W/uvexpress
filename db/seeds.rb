...
Terminal.create(name: 'SM Southmall', latitude:14.433158, longitude: 121.01259124)
Route.create(name: 'Ayala Makati via Skyway', schedule: '5:30AM to 10:00 AM Monday to Saturday only', fare: 'P70', terminal_id: 1)
...
Terminal.create(name: 'Caltex Las Pinas (in front of Starmall Las Pinas)', latitude:14.45091412, longitude: 120.97947046)
Route.create(name: 'Ayala Makati via Coastal Mall', schedule: '5:30AM to 10:00 AM Monday to Saturday only', fare: 'P65', terminal_id: 2)
...
Terminal.create(name: 'Times st. (in front of Perpetual Help)', latitude:14.44807318, longitude: 120.9852165)
Route.create(name: 'Lawton via Coastal', schedule: '5:30AM to 9:303 AM Monday to Saturday only', fare: 'P45', terminal_id: 3)


Terminal.create(name: 'Jollibee Casimiro', latitude:14.44478504, longitude: 120.99401127)
Route.create(name: 'Ayala Makati via Skyway', schedule: '6:00-10:00 or 11:00 AM Monday to Saturday only', fare: 'P70', terminal_id: 4)
...
Terminal.create(name: 'BF Resort Village, Las Pinas', latitude:14.44238698, longitude: 120.99198103)
Route.create(name: 'Ayala Makati via Skyway', schedule: '5:30AM to 10:00 AM Monday to Saturday only', fare: 'P70-P75', terminal_id: 5)
...
Terminal.create(name: 'Park Square Terminal 1st Floor', latitude:14.54911384, longitude: 121.02564812)
Route.create(name: 'BF Homes Paranaque via Skyway', schedule: '12:30 - 11:30 PM Monday to Saturday only', fare: 'P70', terminal_id: 8)
...
Route.create(name: 'Sucat via Skyway', schedule: '1:00-11:00 PM Monday to Saturday only', fare: 'P50-P60', terminal_id: 8)
...
Route.create(name: 'Merville via Skyway', schedule: '1:30-12:00 MN Monday to Saturday only', fare: 'P50', terminal_id: 8)
...
Terminal.create(name: 'Park Square Terminal 2nd Floor', latitude:14.54911384, longitude: 121.02564812)
Route.create(name: 'Market Market', schedule: '6:00 PM - 11:00 PM Monday to Saturday only', fare: 'P30', terminal_id: 9)
