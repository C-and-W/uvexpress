...
class OriginsControllerTest < ActionController::TestCase
  ...
  test "should create origin" do
    assert_difference('Origin.count') do
      post :create, origin: { address: @origin.address, description: @origin.description, latitude: @origin.latitude, longitude: @origin.longitude, title: @origin.title }
    end
  ...
  test "should update origin" do
    patch :update, id: @origin, origin: { address: @origin.address, description: @origin.description, latitude: @origin.latitude, longitude: @origin.longitude, title: @origin.title }
    assert_redirected_to origin_path(assigns(:origin))
  end
