...
class TerminalsControllerTest < ActionController::TestCase
  ...
  test "should create terminal" do
    assert_difference('Terminal.count') do
      post :create, terminal: { address: @terminal.address, fare: @terminal.fare, latitude: @terminal.latitude, longitude: @terminal.longitude, name: @terminal.name, route: @terminal.route }
    end
  ...
  test "should update terminal" do
    patch :update, id: @terminal, terminal: { address: @terminal.address, fare: @terminal.fare, latitude: @terminal.latitude, longitude: @terminal.longitude, name: @terminal.name, route: @terminal.route }
    assert_redirected_to terminal_path(assigns(:terminal))
  end
